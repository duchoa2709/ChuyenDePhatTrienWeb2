            ...
            <form action="/updateManufacture/{{$manufacture->id}}" method="post" enctype="multipart/form-data" class="m-10">
                    ...
                    <div class="flex items-center ">
                        <div class="mt-1 text-sm text-gray-500 text-gray-300" id="user_avatar_help">
                            <div class="relative hidden w-28  h-28 object-contain mr-3 rounded-full md:block">
                                <img class="object-contain w-full h-full " src="/upload/{{$manufacture->Image}}" alt=""
                ...
                <div class="mb-6">
                    ...
                    <input type="text" id="Phone" name="Phone"
                        ...
                        placeholder="Nhập mô tả sản phẩm" required value="{{ $manufacture->Phone }}">
                    @if ($errors->has('Phone'))
                ...
                <div class="mb-6">
                    ...
                    <input type="text" id="Address" name="Address"
                        class="shadow-sm bg-gray-50 border border-gray-300 text-white text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 bg-gray-700 border-gray-600 placeholder-gray-400 focus:ring-blue-500 focus:border-blue-500 shadow-sm-light"
                        placeholder="Nhập mô tả sản phẩm" required value="{{ $manufacture->Address }}">
                ...
                <div class="mb-6">
                    ...
                    <input type="text" id="Representative" name="Representative"
                        class="shadow-sm bg-gray-50 border border-gray-300 text-white text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 bg-gray-700 border-gray-600 placeholder-gray-400 focus:ring-blue-500 focus:border-blue-500 shadow-sm-light"
                        placeholder="Nhập mô tả sản phẩm" required value="{{ $manufacture->Representative }}">
