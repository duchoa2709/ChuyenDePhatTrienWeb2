...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 09, 2023 lúc 04:29 AM
...
INSERT INTO `products` (`id_product`, `name`, `description`, `image`, `price`, `categories_id`, `manufacture_id`, `created_at`, `updated_at`) VALUES
...
(90, 'Bia 333', 'Bia 333', '16994283270002434_333-beer_500.png', 49000, 4, 2, '2023-11-08 00:25:27', '2023-11-08 17:57:33');
...
--
ALTER TABLE `products`
  MODIFY `id_product` int(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=91;
...
--
ALTER TABLE `like`
  ADD CONSTRAINT `like_product` FOREIGN KEY (`id_product`) REFERENCES `products` (`id_product`);
COMMIT;
